...
export default function ThemeSwitch() {
    ...
    return (
        <button 
            ...
            role="switch"
            aria-checked="false">
            <div className="transform translate-y-0 dark:-translate-y-8 transition duration-200 ease-in-out">
                <svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 mb-2">
